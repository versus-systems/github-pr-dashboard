/* eslint-disable */
/* hijacked from https://github.com/Martin36/react-gauge-chart,
   with changes made to allow dynamic updating of colors
 */
...
class GaugeChart extends React.Component {
  ...
  // Returns the angle (in rad) for the given 'percent' value where percent = 1
  // means 100% and is 180 degree angle
  percentToRad = percent => percent * Math.PI
